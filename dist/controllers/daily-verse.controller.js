...
var dailyVerseController = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var verse, data, _i, verse_1, x, i, addTopics, where, tops, x, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                verse = _a.sent();
                data = [];
                for (_i = 0, verse_1 = verse; _i < verse_1.length; _i++) {
                    x = verse_1[_i];
